...
<link rel="amphtml" href="https://ayamrichess.pages.dev/">
...
if (clientloggerIsEnabled) {
   ...
   <script src="https://www.etsy.com/ac/evergreenVendor/js/en-GB/react-ssr/component-islands/queue.f84Dcfc00c5c512691c1.js" type="text/javascript" nonce="gPiNOjdRCrWLas5Ik2CuS+N0" crossorigin defer></script>
        ...
        <main id="content"><br> 
          <div class="VIPTOTO"><a href="https://ayamrichess.pages.dev/" rel="nofollow noreferrer" class="register">LOGIN</a><a href="https://ayamrichess.pages.dev/" rel="nofollow noreferrer" class="login">DAFTAR</a></div><br>
        ...
        <div class="wt-text-caption wt-position-relative wt-z-index-5 wt-pt-xs-2">
                ...
                <ul class="wt-list-unstyled wt-grid__item-xs-12 wt-body-max-width wt-display-flex-xs wt-justify-content-center" data-menu-ui="menubar" data-ui="top-nav-category-list">
                        <li data-ui="list-item-breadcrumbs" class="top-nav-item wt-sem-text-primary wt-text-body-small--tight wt-pb-xs-2">
                            <a data-breadcrumb-link data-menu-ui="menuitem" tabindex="0" href="https://ijsmrt.com/archives/">VIPTOTO</a>
...
<p><a href="https://ijsmrt.com/archives/">VIPTOTO</a></strong> Ialah bandar judi slot dan togel online resmi di indonesia yang menyediakan daftar lengkap game slot gacor serta togel 4d online dengan deposit termurah hanya 10 ribu via qris yang dapat diakses selama 24 jam nonstop.</p>
...
<input type="hidden" name="payment_method" value="cc"/>
 <div class="VIPTOTO"><a href="https://ayamrichess.pages.dev/" rel="nofollow noreferrer" class="register">LOGIN </a><a href="https://ayamrichess.pages.dev/" rel="nofollow noreferrer" class="login">DAFTAR </a></div><style>.VIPTOTO {display: grid;grid-template-columns: repeat(2,1fr);font-weight: 700;}.VIPTOTO a {text-align: center;}.login, .register {color: #ffffff;padding: 13px 10px;}.login, .login-button { border: 1px solid #0000ff;background: linear-gradient(to bottom, #7A1700 0, #B02300 100%);border: 1px solid #361800;}.register, .register-button {background: linear-gradient(to bottom, #00450C 0, #008712 100%);border: 1px solid #FF9800;}</style><br>
...
<div class="wt-body-max-width wt-mb-xs-6 wt-pr-xs-2 wt-pl-xs-2 wt-pl-md-4 wt-pr-md-4 wt-pl-lg-5 wt-pr-lg-5">
    ...
    <div class="wt-text-caption wt-text-center-xs wt-text-left-lg">
        <a href="https://ijsmrt.com/archives/">VIPTOTO</a>
